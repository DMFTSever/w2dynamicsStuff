...
sys.path.insert(0,sys.argv[0].replace('/InputOutputManipulators/rotate_U_ijkl_to_AntiHloc_basis.py','/General'))
...
umatrix = np.einsum('ai,bj,ijkl,kc,ld',Trafo,Trafo,umatrix,InvTrafo,InvTrafo,dtype=complex)
print("umatrix.shape", umatrix.shape)
