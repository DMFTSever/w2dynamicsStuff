...
sys.path.insert(0,sys.argv[0].replace('/InputOutputManipulators/HK_add_SOC.py','/General'))
...
for i in range(0,Na):
		hSOC[0+3*i,1+3*i] = -1j*sigma3
		hSOC[0+3*i,2+3*i] = 1j*sigma1
		hSOC[1+3*i,0+3*i] = 1j*sigma3
		hSOC[1+3*i,2+3*i] = -1j*sigma2
